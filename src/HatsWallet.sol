...
import { Mech } from "mech/base/Mech.sol";
import { ImmutableStorage } from "mech/base/ImmutableStorage.sol";
...
contract HatsWallet is Mech, ImmutableStorage {
  ...
  constructor(address _hatsProtocol, uint256 memory _hatId) {
  ...
  function isOperator(address signer) public view override returns (bool) {
    ...
    return hats().isWearerOfHat(signer, hat());
  }
}
